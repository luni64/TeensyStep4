...
namespace TeensyTimerTool
{
    class BaseTimer
    {
     public:
        ...
        inline errorCode setCurrentPeriod(float microseconds);
    ...
    errorCode BaseTimer::setCurrentPeriod(float us)
    {
        return postError(timerChannel->setCurrentPeriod(us));
    }
    
     template <typename T>
    errorCode BaseTimer::getTriggerReload(float delay, T* reload)
    {
