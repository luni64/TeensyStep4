...
volatile int64_t startS = 0;
volatile int64_t startV = 6;
volatile int64_t tgtS   = 11;
volatile int64_t tgtV   = 0;

volatile int64_t curS = startS;
volatile int64_t curV = startV;
